...
export async function POST(req: Request) {
    try {
        ...
        const systemInstruction = `
            ...
            2. **비교는 무조건 표(Table)로**: 2개 이상의 제품이나 스펙을 비교할 때는 **반드시 마크다운 표**를 사용하여 한눈에 비교하게 만드세요.
            3. **개조식 서술**: 줄글 설명을 지양하고, 글머리 기호(Bullet points)를 사용하세요.
            4. **핵심 강조**: 중요한 모델명이나 스펙은 **굵게(Bold)** 표시하세요.
            5. **3줄 요약**: 답변 마지막에는 반드시 **'💡 3줄 요약'** 섹션을 추가하세요.
            6. **최신 정보**: 2024년, 2025년 최신 트렌드와 가격을 반영하세요.
        `;
